...
legend([hPltSim,  hPltSd, ahplt(1), ahplt(2), ahplt(3), ahplt(4),ahplt(5),ahplt(6)], 'Simulation', 'Calculation', ...
['C1:P_{b,i}=', num2str(aDbPdff(1), '%1.0fdBm')],...
['C2:P_{b,i}=', num2str(aDbPdff(2), '%1.0fdBm')],...
['C3:P_{b,i}=', num2str(aDbPdff(3), '%1.0fdBm')], ...
['C4:P_{b,i}=', num2str(aDbPdff(4), '%1.0fdBm')], ...
['C5:P_{b,i}=', num2str(aDbPdff(5), '%1.0fdBm')], ...
['C6:P_{b,i}=', num2str(aDbPdff(6), '%1.0fdBm')]);
